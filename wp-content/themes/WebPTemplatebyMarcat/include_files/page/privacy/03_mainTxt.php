<section class="wapper btmPrivacy">
    <h2 class="t_center h2BtmPrivacy">個人情報の取り扱いについて</h2>
    
    <section class="secBtmPrivacy">
        <h3 class="h3SecBtmPrivacy">1.個人情報の取得</h3>
    ...
    <section class="secBtmPrivacy">
        <h3 class="h3SecBtmPrivacy h3SecBtmPrivacy01">2.個人情報の利用および共同利用</h3>
        <p class="text_justify txtSecBtmPrivacy">社がお預かりした個人情報は、個人情報を頂いた方に承諾を得た範囲内で、また収集目的に沿った範囲内で利用致します。利用目的については、以下の「利用目的の範囲」の内、当社の正当な事業の範囲内でその目的の達成に必要な事項を利用目的と致します。</p>
        <h3 class="h3SecBtmPrivacy h3SecBtmPrivacy02">[利用目的の範囲について]</h3>
        <p class="text_justify txtSecBtmPrivacy">
            ・業務上のご連絡をする場合<br>
            ・当社が取り扱う商品及びサービスに関するご案内（電子メールや電話など）をする場合<br>
            ・ご利用者様からのお問い合わせまたはご依頼等への対応をさせて頂く場合<br>
            ・その他、ご利用者様に事前にお知らせし、ご同意を頂いた目的の場合
        </p>
        <h3 class="h3SecBtmPrivacy h3SecBtmPrivacy03">[上記目的以外の利用について]</h3>
        <p class="text_justify txtSecBtmPrivacy">上記以外の目的で、ご利用者様の個人情報を利用する必要が生じた場合には、法令により許される場合を除き、その利用について、ご利用者様の同意を頂くものとします。</p>
    </section>
    <section class="secBtmPrivacy">
    ...
    <section class="secBtmPrivacy secBtmPrivacyBnone">
        ...
        <p class="text_justify txtSecBtmPrivacy">
            ・個人情報の開示・修正等の手続<br>
            ご利用者様からご提供頂いた個人情報に関して、照会、訂正、削除を要望される場合は、お問い合わせ先窓口までご請求ください。当該ご請求が当社の業務に著しい支障をきたす場合等を除き、ご利用者様ご本人によるものであることが確認できた場合に限り、合理的な期間内に、ご利用者様の個人情報を 開示、訂正、削除致します。<br>
            <br>
    ...
    <div class="btnContactThanksWap">
        <a href="<?php echo home_url('/'); ?>" class="btnContactThanks">
