<div class="companySocial">
    <div class="wapper companySocialWap">
        <section class="titleCompany">
            <h2 class="t_center oswald cl_006FDB h2TitleCompany">SOCIAL EFFORTS</h2>
            <h3 class="t_center cl_006FDB h3TitleCompany">地域貢献・社会活動</h3>
    ...
    <div class="wapper display_flex_center display_row mainCompanySocial">
        ...
        <div class="cntMainCompanySocial">
            <p class="txtMainCompanySocial">
                当社は地域のお客様に貢献すべく社会活動を積極的に取り組んでおります。<br>地域を守り、皆さんと共に笑顔ある街づくりを目指してまいります。
            </p>
            <section class="po_re MainCompanySocialLxc">
                ...
                <p class="txtMainCompanySocialLxc">
                    新型コロナウイルスで<br class="sp_only">蔓延時に次亜塩素酸水を<br>無料で地域のお客様に<br class="sp_only">お配りさせて頂きました。
                </p>
            </section>
        </div>
    </div>
