            ...
            <div class="navIndexRecruitWap">
                ...
                <ul class="display_flex_stretch ulIndexRecruit">
                    <li class="liIndexRecruit liIndexRecruit01">
                        <a class="btnIndexRecruit" href="<?php echo get_the_permalink(31); ?>#merit" target="_blnak">
                    ...
                    <li class="liIndexRecruit liIndexRecruit02">
                        <a class="btnIndexRecruit" href="<?php echo get_the_permalink(57); ?>" target="_blnak">
                    ...
                    <li class="liIndexRecruit liIndexRecruit03">
                        <a class="btnIndexRecruit" href="<?php echo get_the_permalink(30); ?>" target="_blnak">
